#i realized this file is no longer needed since its basically just tokenizing external datasets and we have a tokenizer 
#also its kinda buggy
...
#         writer.writerow(["plasmid_id", "contig"])# later adjust so that it also reads from quadrupia and invertia and adds columns for those instead of one static contig column
